...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description = 'Interpolated Markov and Markov chain for gene identification')
    parser.add_argument('--input_path', metavar='path', type=str, help='Input FASTA sequence file path')
    parser.add_argument('--max_kmer_length', metavar='int', type=int, help='Max k-mer length used to train model')
    parser.add_argument('--command', metavar='string', type=str, help='Enter which model to use for training and testing')
    args = parser.parse_args()

    genome = readFASTA(args.input_path)
    maxLength = args.max_kmer_length
